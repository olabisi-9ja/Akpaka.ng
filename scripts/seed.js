...
async function seed() {
  ...
  const reviews = [
    { productId: allProducts[0].id, rating: 5, comment: 'Absolutely stunning craftsmanship. The patina is unlike anything I have seen. Worth every naira.', authorName: 'Chidi Okafor', verified: true, source: 'whatsapp' },
    { productId: allProducts[0].id, rating: 5, comment: 'I have bought shoes from Italy and England. These rival the best of them. Prince is a true master.', authorName: 'Emeka Nwankwo', verified: true, source: 'instagram' },
    { productId: allProducts[2].id, rating: 5, comment: 'The Rivers Tassel Loafer is perfection. Comfortable from day one and the leather just gets better with age.', authorName: 'Adaeze Eze', verified: true, source: 'website' },
    { productId: allProducts[4].id, rating: 5, comment: 'The Bonny Chelsea Boot commands respect everywhere I go. The craftsmanship is world-class.', authorName: 'Obinna Udeh', verified: true, source: 'whatsapp' },
    { productId: allProducts[6].id, rating: 5, comment: 'My wedding shoes were the highlight of my outfit. Guests could not stop talking about them. Thank you AkpakaNG!', authorName: 'Tunde Adebayo', verified: true, source: 'whatsapp' },
    { productId: allProducts[7].id, rating: 5, comment: 'A wholecut of this quality at this price is extraordinary. The patina deepens beautifully with each wear.', authorName: 'Femi Adesina', verified: true, source: 'instagram' },
  ];
